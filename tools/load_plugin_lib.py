...
import os
import ctypes
LIB_DIR = "/home/qianhao/TensorRT/lib"
ROI_ALIGN_PLUGIN_LIBRARY_NAME = "libnvinfer_plugin.so"
ROI_ALIGN_PLUGIN_LIBRARY = [os.path.join(LIB_DIR, ROI_ALIGN_PLUGIN_LIBRARY_NAME)]

def load_plugin_lib():
    for plugin_lib in ROI_ALIGN_PLUGIN_LIBRARY:
    ...
    raise IOError(
        "\n{}\n{}\n{}\n".format(
            "Failed to load library ({}).".format(ROI_ALIGN_PLUGIN_LIBRARY_NAME),
