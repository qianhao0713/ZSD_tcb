...
class ConvFCSemanticBBoxHeadDSDU(BBoxSemanticHeadDSDU):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(ConvFCSemanticBBoxHeadDSDU, self).__init__(*args, **kwargs)
    ...
    def init_weights(self):
        super(ConvFCSemanticBBoxHeadDSDU, self).init_weights()
...
@HEADS.register_module
class SharedFCSemanticBBoxHeadDSDU(ConvFCSemanticBBoxHeadDSDU):

    def __init__(self, num_fcs=2, fc_out_channels=1024, *args, **kwargs):
        assert num_fcs >= 1
        super(SharedFCSemanticBBoxHeadDSDU, self).__init__(
            num_shared_convs=0,
